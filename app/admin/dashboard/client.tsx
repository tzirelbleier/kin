      ...
      {open && (
        <div style={{ marginTop: 12, padding: 16, background: 'var(--color-bg)', borderRadius: 8, border: '1px solid var(--color-border)', fontSize: 13 }}>
          ...
          <div style={{ marginBottom: 10 }}>
            ...
            <code style={{ display: 'block', background: '#1e1b2e', color: '#e2e8f0', padding: '8px 12px', borderRadius: 6, fontSize: 12, wordBreak: 'break-all' }}>{appUrl}{webhookPath}</code>
          </div>
          <div style={{ marginBottom: 10 }}>
            ...
            <code style={{ display: 'block', background: '#1e1b2e', color: '#e2e8f0', padding: '8px 12px', borderRadius: 6, fontSize: 12 }}>x-kin-webhook-secret: {'<WEBHOOK_SECRET>'}</code>
          </div>
...
export function AdminDashboardClient({ tickets, events, auditLog, facilityId, profiles, residents }: Props) {
  ...
  return (
    <div className="kin-page">
      {/* Nav is rendered by AdminNav in layout.tsx */}
