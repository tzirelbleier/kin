...
export async function POST(req: Request) {
  ...
  const menus = [
    ...
    // Resident-specific dietary items (this week)
    ...
    // Next week (Mon = offset 7)
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(7),  meal_type: 'breakfast', title: 'Avocado toast with poached egg, grapefruit juice' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(7),  meal_type: 'lunch',     title: 'Lentil soup, whole grain roll, mixed greens salad' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(7),  meal_type: 'dinner',    title: 'Herb-roasted pork loin, sweet potato mash, Brussels sprouts' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(7),  meal_type: 'snack',     title: 'Trail mix & orange slices (3 PM)' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(8),  meal_type: 'breakfast', title: 'Banana pancakes, turkey sausage, apple cider' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(8),  meal_type: 'lunch',     title: 'Caprese panini, tomato bisque, lemon panna cotta' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(8),  meal_type: 'dinner',    title: 'Shrimp stir-fry with jasmine rice & bok choy', description: 'Shellfish allergen — alternative: tofu' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(8),  meal_type: 'snack',     title: 'Hummus & veggie sticks (3 PM)' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(9),  meal_type: 'breakfast', title: 'Belgian waffle, fresh strawberries, whipped cream' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(9),  meal_type: 'lunch',     title: 'Pulled chicken sandwich, coleslaw, pickle chips' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(9),  meal_type: 'dinner',    title: 'Lamb chops with mint jelly, roasted carrots & couscous' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(9),  meal_type: 'snack',     title: 'Rice pudding with raisins (3 PM)' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(10), meal_type: 'breakfast', title: 'Smoked salmon bagel, cream cheese, capers' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(10), meal_type: 'lunch',     title: 'Greek salad with grilled chicken, pita & tzatziki' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(10), meal_type: 'dinner',    title: 'Beef meatballs, marinara, spaghetti, garlic bread' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(10), meal_type: 'snack',     title: 'Chips & salsa — Happy Hour (3:30 PM)' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(11), meal_type: 'breakfast', title: 'Veggie omelette, rye toast, tomato juice' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(11), meal_type: 'lunch',     title: 'Lobster bisque, sourdough, Caesar side salad' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(11), meal_type: 'dinner',    title: 'Roast turkey breast, stuffing, cranberry sauce, green beans' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(11), meal_type: 'snack',     title: 'Pumpkin pie slice & decaf coffee (2:30 PM)' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(12), meal_type: 'breakfast', title: 'Weekend Brunch: French omelette station, croissants' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(12), meal_type: 'lunch',     title: 'Build-your-own burger bar, sweet potato fries' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(12), meal_type: 'dinner',    title: 'Pan-seared tilapia, lemon butter, wild rice & asparagus' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(12), meal_type: 'snack',     title: 'Brownie sundae (2:30 PM)' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(13), meal_type: 'breakfast', title: 'Eggs Benedict, fruit cup, mimosa (non-alcoholic)' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(13), meal_type: 'lunch',     title: 'Sunday Roast: prime rib, roasted potatoes, Yorkshire pudding' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(13), meal_type: 'dinner',    title: 'Vegetable minestrone, crusty bread, tiramisu' },
    { facility_id: FACILITY_ID, resident_id: null, date: weekDate(13), meal_type: 'snack',     title: 'Cookies & herbal tea (3 PM)' },
    // Next week resident-specific
    { facility_id: FACILITY_ID, resident_id: r1, date: weekDate(7),  meal_type: 'dinner',    title: 'Low-sodium pork loin with steamed veg', description: 'Heart diet — no added salt' },
    { facility_id: FACILITY_ID, resident_id: r2, date: weekDate(8),  meal_type: 'dinner',    title: 'Pureed shrimp with smooth rice porridge', description: 'IDDSI Level 4' },
    { facility_id: FACILITY_ID, resident_id: r3, date: weekDate(10), meal_type: 'lunch',     title: 'Diabetic Greek salad with grilled chicken (no croutons)', description: 'Carb count: ~20g' },
  ]
